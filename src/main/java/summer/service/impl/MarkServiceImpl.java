...
import summer.mapper.MarkMapper;
import summer.service.MarkService;
...
public class MarkServiceImpl implements MarkService{
	...
	@Override
	public void insertmark(int user_id, int order_id, String mark_wl, String mark_zl, String mark_fw) {
		// TODO Auto-generated method stub
		markMapper.insertmark(user_id, order_id, mark_wl, mark_zl, mark_fw);
	}

	@Override
	public List<Mark> readmark(int user_id) {
		// TODO Auto-generated method stub
