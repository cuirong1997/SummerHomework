		...
		<section class="m-t-30"> 
			<div class="container">
				<table class="table table-striped">
					<thead >
						<tr>
							<th style="text-align: center;width: 13%">土地名称</th>
							<th style="text-align: center;width: 13%">土地单价</th>
					...
					<c:forEach items="${collect_list}" var="collect"> 
						<tr>
								<td style="vertical-align:middle;text-align: center;">${collect.collect_name} </td>
								<td style="vertical-align:middle;text-align: center;">${collect.collect_price}元/斤</td>
								<td style="vertical-align:middle;text-align: center;"><img src="images/${collect.collect_image}" class="img-responsive;display: block;" style="max-width: 20%;height: auto;"/></td>
								<td style="vertical-align:middle;text-align: center;"><a href="interest"><button type="button" class="btn btn-danger">我感兴趣</button></a></td>
								<td style="vertical-align:middle;text-align:center;"><a href="rowdeletecol?land_id=${collect.collect_lid}"><button type="button" class="btn btn-danger">删除</button></a></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
