	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>新闻管理</a>>><a>新闻信息查看修改</a></li>
			</ol>
		</div>			
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">新闻信息查看修改</div>
					<div class="panel-body">
						<table>
						    <thead>
						    <tr>
						        <th class="mnews" style="width:30%">新闻名</th>
								<th class="mnews" style="width:30%">新闻链接</th>
								<th class="mnews" style="width:20%">发布时间</th>
								<th class="mnews" style="width:20%"></th>
						    </tr>
						    </thead>
							<tbody>
								<c:forEach items="${requestScope.news_list }" var="news">
									<tr>
										<td class="jz1">${news.news_name }</td>
										<td class="jz1">${news.news_href }</td>
										<td class="jz1">${news.news_time }</td>
										<td class="jz1"><a href="deletenews?id=${news.news_id } "><button type="button" class="btn btn-danger">删除新闻</button></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
