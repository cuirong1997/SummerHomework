	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>滞销蔬果管理</a>>><a>滞销蔬果信息添加</a></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">滞销蔬果信息添加</div>
					<div class="panel-body">
						<div class="col-lg-12">
							<form action="add" method="post">
								...
								<div class="form-group">
									<label>果实大小：</label>
									<input type="text" class="form-control" placeholder="尺寸大小" name="dx">
								</div>
								<div class="form-group">
									<label>成熟时间：</label>
									<input type="text" class="form-control" placeholder="种植周期" name="time">
								</div>
								<div class="form-group">
									<label>株距：</label>
									<input type="text" class="form-control" placeholder="株距" name="distance">
								</div>
								<div class="form-group">
									<label>种植面积：</label>
								...
								<div class="form-group">
									<label>简介：</label>
									<input type="text" class="form-control" placeholder="简介" name="remark">
								</div>
								<div class="form-group">
									<label>单价：</label>
								...
								<div class="form-group">
									<label>滞销蔬果总量：</label>
									<input type="text" class="form-control" placeholder="滞销蔬果总量" name="store">
								</div>
								<div class="form-group">
									<label>详细描述：</label>
									<input type="text" class="form-control" placeholder="详细描述" name="detail">
								</div>
								<div class="form-group">
									<label>营养成分：</label>
									<input type="text" class="form-control" placeholder="营养成分" name="contain">
								</div>
								<div class="form-group">
									<label>图片</label>
