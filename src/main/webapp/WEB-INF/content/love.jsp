				...
				<table class="table table-striped">
					<thead >
						<tr>
							...
							<th style="text-align: center;width: 14%">总价</th>
							<th style="text-align: center;width: 14%">目的地</th>
							<th style="text-align: center;width: 30%">图片</th>
						</tr>
					</thead>
					<tbody>
					<c:forEach items="${love_list}" var="love"> 
						<tr>
								<td style="vertical-align:middle;text-align: center;">${love.love_name} </td>
								<td style="vertical-align:middle;text-align: center;">${love.love_number}斤</td>
								<td style="vertical-align:middle;text-align: center;">${love.love_price}元</td>
								<td style="vertical-align:middle;text-align: center;">${love.love_mdd}</td>
								<td style="vertical-align:middle;text-align: center;">${love.love_status}</td>
								<td style="vertical-align:middle;text-align: center;"><img src="images/${love.love_image}" class="img-responsive;" style="display: block;max-width: 20%;height: auto;"/></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
