	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>新闻管理</a>>><a>新闻信息添加</a></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">新闻信息添加</div>
					<div class="panel-body">
						<div class="col-lg-12">
							<form action="intonews" method="post">
								<div class="form-group">
									<label>新闻题目：</label>
									<input type="text"class="form-control" placeholder="新闻题目" name="news_name">
								</div>			
								<div class="form-group">
									<label>新闻链接：</label>
									<input type="text" class="form-control" placeholder="新闻链接" name="news_href">
								</div>
								<div class="form-group">
									<label>发布时间：</label>
									<input type="text" class="form-control" placeholder="发布时间" name="news_time">
								</div>
								<div class="form-group">
