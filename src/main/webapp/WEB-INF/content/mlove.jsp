	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>爱心计划</a>>><a>爱心计划信息修改</a></li>
			</ol>
		</div>			
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">爱心计划信息修改</div>
					<div class="panel-body">
						<table class="table">
						    ...
						    <tbody>
						    <c:forEach items="${requestScope.love_list}" var="love">
									<form action="updatelovestatus?love_id=${love.love_id }" method="post">
										<tr>
											<td class="jz" >${love.love_id }</td>
											<td class="jz" >${love.love_uid }</td>
											<td class="jz">${love.love_gid }</td>
											<td class="jz" >${love.love_name }</td>
									 		<td class="jz" >${love.love_number }</td>
											<td class="jz" >${love.love_price}</td>
											<td class="jz" >${love.love_mdd}</td>
											<td class="jz"><img  class="img-responsive;"style="max-width: 50%;height: auto;" src="images/${love.love_image}"/></td>
											<td class="jz">
												<select name="love_status" id="love_status">   
											        <option value="${love.love_status}">${love.love_status}</option>   
