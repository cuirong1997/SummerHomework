	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>承包土地管理</a>>><a>待承包土地信息修改</a></li>
			</ol>
		</div>			
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						<table>
						    ...
						    <tr>
						        ...
						        <th data-field="land">产量</th>
								<th data-field="size">土地源地</th>
								<th data-field="area">作物品种</th>
								<th data-field="total">种植区面积</th>
								<th data-field="price">承包价格</th>
							...
							<c:forEach items="${requestScope.land_list }" var="land">
								<form action="lupdate" method="post">
										<tr>
											<td>${land.land_id}</td>
											<td><input class="form-control" type="text" value="${land.land_name}" name="name"></td>
											<td><input class="form-control" type="text" value="${land.land_output}" name="output"></td>
											<td><input class="form-control" type="text" value="${land.land_place}" name="place"></td>
											<td><input class="form-control" type="text" value="${land.land_kind}" name="kind"></td>
											<td><input class="form-control" type="text" value="${land.land_area}" name="area"></td>
											<td><input class="form-control" type="text" value="${land.land_price}" name="price"></td>
											<td><img src="images/${land.land_image}" alt="枇杷图" class="img-rounded" style="width:30%"></td>
											<td><input type="submit" class="btn btn-success" value="修改信息"></td>
											<td><a href="deleteland?id=${land.land_id}"><button type="button" class="btn btn-danger">删除信息</button></a></td>
										</tr>
									</form>
								</c:forEach>
