	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>评论管理</a>>><a>评论查看</a></li>
			</ol>
		</div>			
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">评论查看</div>
					<div class="panel-body">
						<table>
						    ...
						    <tr>
						        ...
						        <th data-field="gid">商品ID</th>
						        -->
						        <th class="mnews" style="width:90%">评论内容</th>
								<th class="mnews" style="width:50%"></th>
						    </tr>
						    </thead>
							<tbody>
								...
								<tr>
									<!-- 
									<td>${comment.com_uid }</td>
									<td>${comment.com_gid }</td>
									 -->
									<td class="jz1">${comment.com_con }</td>
									<td class="jz1"><a href="deletecom?id=${comment.com_id }"><button type="button" class="btn btn-danger">删除评论</button></a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
