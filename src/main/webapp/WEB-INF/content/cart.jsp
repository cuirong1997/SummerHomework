				...
				<table class="table table-striped">
					<thead >
						<tr>
							...
							<th style="text-align: center;width: 13%">购买数量</th>
							<th style="text-align: center;width: 14%">单价</th>
					...
					<c:forEach items="${cart_list}" var="cart"> 
						<tr>
							<form action="rowupdate?good_id=${cart.cart_gid}" method="post">
								<td style="vertical-align:middle;text-align: center;">${cart.cart_gname} </td>
								<td style="vertical-align:middle;text-align: center;"><input type="number" value="${cart.cart_number}" name="good_number" style="width:60%">斤</td>
								<td style="vertical-align:middle;text-align: center;">${cart.cart_price}元/斤</td>
								<td style="vertical-align:middle;text-align: center;"><img src="images/${cart.cart_image}" class="img-responsive;" style="display: block;max-width: 20%;height: auto;"/></td>
								<td style="vertical-align:middle;text-align: center;"><input type="submit" class="btn btn-success" value="修改购物车"></button></td>
								<td style="vertical-align:middle;text-align:center;"><a href="rowdelete?good_id=${cart.cart_gid}"><button type="button" class="btn btn-danger">删除</button></a></td>
							</form>
							<td style="vertical-align:middle;text-align: center;">
								<form action="intoorder?good_id=${cart.cart_gid}" method="post">
									...
									<input type="submit" class="btn btn-success" value="加入订单" ></button>
								</form>
							</td>
						</tr>
					</c:forEach>
