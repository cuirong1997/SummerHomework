							...
							<div class="box p-40 p-xs-20 bg-white">
								<form action="updatepwd" method="post">
									<div class="form-group">
										<label class="control-label" for="input-email">旧密码：</label>
										<input type="text" name="oldpassword" value="" placeholder="请输入当前密码" id="password" class="form-control form-item">
									</div>
									<div class="form-group m-t-30">
										<label class="control-label" for="input-password">新密码</label>
										<input type="text" name="password" placeholder="请输入修改密码" id="email" class="form-control form-item">
									</div>
									<button type="submit" class="btn ht-btn bg-6">修改密码</button>
								</form>
							</div>
						</div>
					 </div>
