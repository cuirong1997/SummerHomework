	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>用户管理</a>>><a>用户信息查看</a></li>
			</ol>
		</div>			
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">用户信息查看</div>
					<div class="panel-body">
						<table>
						    <thead>
						    <tr>
						        <th data-field="oid">用户ID</th>
						        <th data-field="name">用户名</th>
								<th data-field="email">邮箱号</th>
								<th data-field="sfid">身份证号</th>
								<th data-field="tel">电话号码</th>
								<th data-field="tel">用户地址</th>
								<th></th>
						    </tr>
						    </thead>
							<tbody>
								<c:forEach items="${requestScope.user_list }" var="user">
									<tr>
										...
										<td>${user.user_sfid }</td>
										<td>${user.user_tel }</td>
										<td>${user.user_address }</td>
										<td><a href="deleteuser?id=${user.user_id } "><button type="button" class="btn btn-danger">删除用户</button></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
