	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">当前位置：>><a>承包土地管理</a>>><a>待承包土地信息添加</a></li>
			</ol>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">待承包土地信息添加</div>
					<div class="panel-body">
						<div class="col-lg-12">
							<form action="ladd" method="post">
								...
								<div class="form-group">
									<label>产量：</label>
									<input type="text" class="form-control" placeholder="例：1000斤/年或1000斤/种植周期" name="output">
								</div>
								<div class="form-group">
									<label>土地源地：</label>
									<input type="text" class="form-control" placeholder="所属的省、市、县" name="place">
								</div>
								<div class="form-group">
									<label>作物品种：</label>
									<input type="text" class="form-control" placeholder="如：红富士苹果" name="kind">
								</div>
								<div class="form-group">
									<label>种植区面积：</label>
									<input type="text" class="form-control" placeholder="种植面积" name="area">
								</div>
								<div class="form-group">
									<label>承包价格：</label>
									<input type="text" class="form-control" placeholder="××元/亩" name="price">
								</div>
								<div class="form-group">
									<label>详细描述：</label>
									<input type="text" class="form-control" placeholder="详细描述" name="remark">
								</div>
								<div class="form-group">
									<label>图片：</label>
									<input type="file" placeholder="选择文件" name="image">
								</div>
								<div class="form-group">
									<label>图片：</label>
									<input type="file" placeholder="选择文件" name="image1">
								</div>
								<div class="form-group">
									<label>图片：</label>
									<input type="file" placeholder="选择文件" name="image2">
								</div>
								<div class="form-group">
									<label>图片：</label>
									<input type="file" placeholder="选择文件" name="rimage">
								</div>
								<div class="form-group">
									<input type="submit" class="btn btn-success" value="添加信息">
								</div>
							</form>
						</div>
					</div>
