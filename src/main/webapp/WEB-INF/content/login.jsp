							...
							<div class="box p-40 p-xs-20 bg-white">
								<form action="login" method="post">
									...
									<div class="form-group m-t-30">
										...
										<input type="password" name="password" value="" placeholder="请输入密码" id="pwd" class="form-control form-item">
										<input type="checkbox"  id="checkbox"/>记住密码
									</div>
									<button type="submit" class="btn ht-btn bg-6" onclick="Save()">登录</button><a class="m-b-30" href="emailback">忘记密码</a>
									<a href="enrollbutton"><input type="button" value="注册" class="btn ht-btn bg-6"/></a>
								</form>
							</div>
						</div>
					 </div>
